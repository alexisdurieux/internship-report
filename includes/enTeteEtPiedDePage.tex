...
\fancyhead[R]{\includegraphics[scale=0.05]{images/asi.jpeg}}
\fancyhfoffset{0pt}
	\fancyfoot[R]{\setstretch{0,8}\small{Alexis \textsc{Durieux} }}
\fancyfoot[L]{\includegraphics[scale=0.14]{images/insa.jpg}}
